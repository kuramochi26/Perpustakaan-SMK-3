...
header("content-disposition: attachment; filename=laporan-pengunjung-siswa-smkn3-($tanggal_mulai-$tanggal_selesai).xls");
...
$semuadata=array();
	...
	$ambil=mysqli_query($koneksi,"SELECT * FROM bukutamusiswa LEFT JOIN kelas ON bukutamusiswa.id_kelas=kelas.id_kelas LEFT JOIN jurusan ON bukutamusiswa.id_jurusan=jurusan.id_jurusan WHERE tanggal_berkunjung BETWEEN '$tanggal_mulai' AND '$tanggal_selesai'");
