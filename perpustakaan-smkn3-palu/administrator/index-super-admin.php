...
if ($_SESSION['admin']['level']!="super admin") {
  echo "<script>alert('Maaf Halaman Ini Tidak Dapat Diakses Oleh Admin')</script>";
...
<div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index-super-admin.php">PERPUSTAKAAN</a> 
</div>
<?php
$tgl=date('Y-m-d');
?>
...
?> 
        ...
        <li class="text-center">
          ...
          ?>
                    ...
                    <li>
                        <a  href="index-super-admin.php"><img src="https://img.icons8.com/ios-filled/50/000000/home-page.png">  HOME</a>
                    </li>
                     <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#"><img src="https://img.icons8.com/ios-filled/50/000000/gear.png"> SETTINGS<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="index-super-admin.php?page=pengguna">PENGGUNA</a>
                            </li>
                            <li>
                                <a href="index-super-admin.php?page=kelas">KELAS</a>
                            </li>
                              <li>
                                <a href="index-super-admin.php?page=jurusan">JURUSAN</a>
                            </li>
                             <li>
                                <a href="index-super-admin.php?page=kategori">KATEGORI</a>
                            </li>
                        </ul>
                      </li>   
                </ul>
      ...
      <div id="page-wrapper" >
            <div id="page-inner">
              ...
              if (isset($_GET['page'])) {
                ...
                }elseif ($_GET['page']=='tambah-akun') {
                    include 'tambah-akun.php';
                }elseif ($_GET['page']=='info-pengguna') {
                    include 'info-pengguna.php';
                }
              }else{
                include 'home.php';
              }
